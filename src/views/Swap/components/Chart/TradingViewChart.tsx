...
const bnbToWPSBymbol = (sym: string) => (sym === 'PLS' ? 'WPLS' : sym)
...
const TradingViewChart = ({
  ...
  const symbol = useMemo(() => {
    ...
    const prefix = 'PulseShib:'
    const input = bnbToWPSBymbol(inputCurrency.symbol)
    const output = bnbToWPSBymbol(outputCurrency.symbol)
