...
import { getaRCHLinkForNft } from 'utils'
  ...
  return (
    <>
      <Flex px="24px" pt="24px" flexDirection="column">
          ...
          <Flex flexDirection="column" justifyContent="space-evenly">
            ...
            <Flex justifyContent="space-between" alignItems="center">
              ...
              <Button
                ...
                external
                variant="text"
                href={getaRCHLinkForNft(nftToBuy.collectionAddress, nftToBuy.tokenId)}
              >
                {nftToBuy.tokenId}
              </Button>
            </Flex>
        ...
        <BorderedBox>
          ...
          <ButtonMenu
            ...
            variant="subtle"
          >
            <ButtonMenuItem>PLS</ButtonMenuItem>
            <ButtonMenuItem>WPLS</ButtonMenuItem>
          </ButtonMenu>
          <Text small color="textSubtle">
            {t('Total payment')}
          </Text>
          ...
          <Text small color="textSubtle">
            {t('%symbol% in wallet', { symbol: paymentCurrency === PaymentCurrency.PLS ? 'PLS' : 'WPLS' })}
          </Text>
          {!account ? (
          ...
          <Message p="8px" variant="danger">
            <Text>
              {t('Not enough %symbol% to purchase this NFT', {
                symbol: paymentCurrency === PaymentCurrency.PLS ? 'PLS' : 'WPLS',
              })}
            </Text>
          </Message>
        )}
        <Flex alignItems="center">
          <Text my="16px" mr="4px">
            {t('Convert between PLS and WPLS for free')}:
          </Text>
          <Button
            as={Link}
            p="0px"
            ...
            external
            variant="text"
            href="/swap?inputCurrency=PLS&outputCurrency=0xA1077a294dDE1B09bB078844df40758a5D0f9a27"
          >
            {t('Convert')}
          </Button>
        </Flex>
      ...
      <Flex px="24px" pb="24px" flexDirection="column">
        ...
        <Button as={Link} external style={{ width: '100%' }} href="/swap?outputCurrency=PLS" variant="secondary">
          {t('Get %symbol1% or %symbol2%', { symbol1: 'PLS', symbol2: 'WPLS' })}
        </Button>
      </Flex>
    </>
  )
