          ...
          <Table>
            <thead>
              <tr>
                ...
                <Th textAlign="left" style={{ cursor: 'pointer' }} onClick={() => handleSort(SORT_FIELD.volumePLS)}>
                  {t('Volume')}
                  {arrow(SORT_FIELD.volumePLS)}
                </Th>
                {!isMobile && (
                  <>
            ...
            <tbody>
              {sortedCollections.map((collection) => {
                const volume = collection.totalVolumePLS
                  ? parseFloat(collection.totalVolumePLS).toLocaleString(undefined, {
