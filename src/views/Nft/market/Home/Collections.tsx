...
import { PLSAmountLabel } from '../components/CollectibleCard/styles'
...
const Collections = () => {
  ...
  const orderedCollections = orderBy(
    collections,
    (collection) => (collection.totalVolumePLS ? parseFloat(collection.totalVolumePLS) : 0),
    'desc',
  )
          ...
          return (
            ...
            >
              <Flex alignItems="center">
                ...
                <PLSAmountLabel amount={collection.totalVolumePLS ? parseFloat(collection.totalVolumePLS) : 0} />
              </Flex>
            </HotCollectionCard>
          )
        })}
