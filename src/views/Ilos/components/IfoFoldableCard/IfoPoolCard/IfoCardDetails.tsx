...
if(status!==-2)
  {console.log(publicIfoData.maxUserAmount.toString())
    ...
    <FooterEntry label={t('Max entry:')} value={publicIfoData.maxUserAmount.toString()!=="0"?(publicIfoData.maxUserAmount/1000000000000000000).toString().concat(" PLS"):"No Limit"} />
  
  
  <FooterEntry label={t('Price Per:')} value={(1000000000000000000/publicIfoData.costPresaleBNB).toFixed(0).toString().concat(" ").concat(publicIfoData.symbol.toString())} />
