  ...
  return (
    <Container>
      ...
      <Flex>
            ...
            <Flex alignItems="center" mr="8px">
              <Text color="textSubtle">{Number(publicIfoData.softcap)/1000000000000000000}&nbsp;PLS</Text>
           </Flex>
          </Flex>
          <Flex>
            <Text bold mr="8px">
            ...
            <Flex alignItems="center" mr="8px">
              <Text color="textSubtle">{Number(publicIfoData.hardcap)/1000000000000000000}&nbsp;PLS</Text>
           </Flex>
          </Flex>
        <StyledLinkExternal href={"https://scan.pulsechain.com/token/".concat(publicIfoData.ILOToken.toString())}>{t('View Contract')}</StyledLinkExternal>
      </Flex>
    </Container>
  )
}
