      ...
      <FoldableContent  isActive={publicIfoData.status !== -1 && publicIfoData.status !== 2}>
        ...
        {isActive && <Timer publicIfoData={publicIfoData} />}
          <div style={{textAlign:"center"}}>
              ...
              {
              /*  publicIfoData.maxUserAmount.toString()==="0"?<h1>No Limit</h1>:<div><h1>Limit</h1>&nbsp;{getFullDisplayBalance(new BigNumber(publicIfoData.maxUserAmount),18,2).concat(" per User")}</div>  */
              }
            </div>
            <br/>
