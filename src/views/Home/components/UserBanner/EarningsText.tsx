...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and PSB pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and PSB pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from PSB pool', data)
  }
