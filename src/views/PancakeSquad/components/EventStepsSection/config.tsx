  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active PulseShib Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold PSB'),
      bodyText: [t('Each NFT costs PSB to mint. Remember you also need PLS to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://shibshift.com/swap?outputCurrency=0xCFDAeCeeF1Da66eC26Cfb5BE1ef3a5b70BD6e37C"
            target="_blank"
            width="100%"
          >
            {t('Buy PSB')}
