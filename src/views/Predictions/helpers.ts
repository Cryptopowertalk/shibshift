...
const MIN_PRICE_PLS_DISPLAYED = BigNumber.from('1000000000000000')
...
export const formatBnbv2 = (bnb: BigNumber) => {
  return formatPriceDifference({ price: bnb, minPriceDisplayed: MIN_PRICE_PLS_DISPLAYED, unitPrefix: '', decimals: 18 })
}
