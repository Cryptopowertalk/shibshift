...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningText = t("please make sure you're visiting https://shibshift.com - check the URL carefully.")
  const warningTextAsParts = warningText.split(/(https:\/\/shibshift.com)/g)
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://shibshift.com'}
          color={text === 'https://shibshift.com' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
