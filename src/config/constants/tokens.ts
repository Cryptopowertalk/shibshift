...
export const mainnetTokens = {
  ...
  // bnb here points to the wbnb contract. Wherever the currency PLS is required, conditional checks for the symbol 'PLS' can be used
  bnb: new Token(MAINNET, '0xA1077a294dDE1B09bB078844df40758a5D0f9a27', 18, 'PLS', 'PLS', 'https://www.binance.com/'),
  cake: new Token(
    MAINNET,
    '0xCFDAeCeeF1Da66eC26Cfb5BE1ef3a5b70BD6e37C',
    18,
    'PSB',
    'PulseShib',
    'https://shibshift.com/',
  ...
  syrup: new Token(
    MAINNET,
    '0x31d9C0866E6aDD002d1921e610dEDdE269D2f668',
    18,
    'PSBRT',
    'PSBRT',
    'https://shibshift.com/',
  ...
  lazio: new Token(
    ...
    'LAZIO',
    'FC Lazio Fan Token',
    'https://launchpad.binance.com/en/subscription/LAZIO_PLS',
  ),
  ...
  porto: new Token(
    ...
    'PORTO',
    'FC Porto Fan Token',
    'https://launchpad.binance.com/en/subscription/PORTO_PLS',
  ),
  kart: new Token(
    MAINNET,
  ...
  santos: new Token(
    ...
    'SANTOS',
    'FC Santos Fan Token',
    'https://launchpad.binance.com/en/launchpool/SANTOS_PLS',
  ),
  nabox: new Token(
    MAINNET,
