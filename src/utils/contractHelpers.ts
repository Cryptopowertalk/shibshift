...
import wrappedPLS from 'config/abi/wrappedBnb.json'
...
export const getIfoV4Contract = (address: string, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(IfoV4Abi, address, signer)
}
...
export const getwrappedPLSContract = (address: string, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(wrappedPLS, address, signer)
}
